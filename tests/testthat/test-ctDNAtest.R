...
tests1 <- list(
   test1 = test_ctDNA(mutations = mutations, bam = bamT1, 
       targets = targets, reference = BSgenome.Hsapiens.UCSC.hg19,
       n_simulation = 100, informative_reads_threshold = 100),
   test2 = test_ctDNA(mutations = mutations, bam = bamT1, informative_reads_threshold = 100,
       targets = targets, reference = BSgenome.Hsapiens.UCSC.hg19,
       n_simulation = 100, ID_column = "PHASING"),
   test3 = test_ctDNA(mutations = mutations, bam = bamT1, informative_reads_threshold = 100,
       targets = targets, reference = BSgenome.Hsapiens.UCSC.hg19,
       n_simulation = 100, ID_column = "PHASING", black_list = "chr14_106327474_C_G"),
   test4 = test_ctDNA(mutations = mutations, bam = bamT1, informative_reads_threshold = 100,
...
tests2 <- list(
  test1 = test_ctDNA(mutations = mutations, bam = bamT2, 
       targets = targets, reference = BSgenome.Hsapiens.UCSC.hg19,
       n_simulation = 100, informative_reads_threshold = 100),
  test2 = test_ctDNA(mutations = mutations, bam = bamT2, informative_reads_threshold = 100,
       targets = targets, reference = BSgenome.Hsapiens.UCSC.hg19,
       n_simulation = 100, ID_column = "PHASING"),
  test3 = test_ctDNA(mutations = mutations, bam = bamT2, informative_reads_threshold = 100,
       targets = targets, reference = BSgenome.Hsapiens.UCSC.hg19,
       n_simulation = 100, ID_column = "PHASING", black_list = "chr14_106327474_C_G"),
...
bgr <- list(
  bgr1 = get_background_rate(bamT2, targets = targets, reference = BSgenome.Hsapiens.UCSC.hg19, 
        min_base_quality = 20),
  bgr2 = get_background_rate(bamT2, targets = targets, reference = BSgenome.Hsapiens.UCSC.hg19,
        min_base_quality = 30),
  bgr3 = get_background_rate(bamT2, targets = targets, reference = BSgenome.Hsapiens.UCSC.hg19,
        black_list = "chr14_106327474_C_G"),
  bgr4 = get_background_rate(bamT2, targets = targets, reference = BSgenome.Hsapiens.UCSC.hg19,
